...
const attendanceData = [
  ...
  { day: 16, status: "absent" }, { day: 17, status: "present" }, { day: 18, status: "present" },
  { day: 19, status: "present" }, { day: 20, status: "present" }, { day: 21, status: "present" },
  { day: 22, status: "present" }, { day: 23, status: "present" }, { day: 24, status: "late" },
  { day: 25, status: "present" }, { day: 26, status: "present" },
];
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex items-center justify-center gap-6 mt-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-2"><div className="h-3 w-3 rounded-full bg-emerald-500" /><span className="text-sm text-gray-600">Present ({present})</span></div>
            <div className="flex items-center gap-2"><div className="h-3 w-3 rounded-full bg-red-500" /><span className="text-sm text-gray-600">Absent ({absent})</span></div>
            <div className="flex items-center gap-2"><div className="h-3 w-3 rounded-full bg-amber-500" /><span className="text-sm text-gray-600">Late ({late})</span></div>
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            {months.map((m) => {
              const pct = m === "May" ? 92 : m === "April" ? 88 : m === "March" ? 95 : m === "February" ? 90 : 93;
              return (
                <div key={m} className="flex items-center justify-between p-3 rounded-lg border border-gray-50">
                  <span className="text-sm text-gray-600">{m} 2025</span>
